...
def transform_callback(data):       
    ...
    lane_distance = abs(data.lane1.centroid - data.lane2.centroid)

    # Compute the center of the lanes as the average of their centroids
    lane_center = (data.lane1.centroid + data.lane2.centroid) / 2.0
    
    # Calculate the distance from the camera using the lane distance
    # and a calibration factor
    calibration_factor = 0.1 # adjust this based on your camera
    distance_from_camera = calibration_factor * lane_distance
